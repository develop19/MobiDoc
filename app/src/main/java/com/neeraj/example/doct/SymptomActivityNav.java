...
public class SymptomActivityNav extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //parseIntent();
      //  dispSymp.add("No Symptoms Selected. Please add some symptom");
        setAdapter();
        ...
        tap.setOnClickListener(new View.OnClickListener() {
         ...
         //       String[] Arr=dispSymp.toArray(new String[dispSymp.size()]);
         //       if(Arr[0]=="No Symptoms Selected. Please add some symptom")
                String[] Arr=dispSymp.toArray(new String[dispSymp.size()]);
         //           dispSymp.clear();
                if (!acTextView.getText().toString().equals("")) {
                   // String[] Arr=dispSymp.toArray(new String[dispSymp.size()]);
                    ...
                    if (flag == 0) {
                     //   Toast.makeText(SymptomActivityNav.this,"Please enter a symptom from the given list",Toast.LENGTH_SHORT).show();
                        acTextView.setText("");
                        //Toast.makeText(SymptomActivityNav.this, "Please enter a valid symptom", Toast.LENGTH_SHORT).show();
                    /*   if (v != null) {
                            InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == false) {
                ...
                try {
                    ...
                    if(jar.length()==0)
                    {
                        Toast.makeText(SymptomActivityNav.this, "Sorry, no symptoms matched. Please try again or select symptoms from the dropdown menu.", Toast.LENGTH_SHORT).show();
                    }
